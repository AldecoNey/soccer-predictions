...
8. **Presupuesto máximo: USD 30/mes** combinando datos + hosting (actualmente ~$19-26/mes, API-Football Pro + hosting — ver ADR-0002, ADR-0003, ADR-0017). Cualquier gasto nuevo o upgrade de plan pago requiere aprobación explícita del usuario antes de contratarse.
