...
- No implementa features de producto, pipelines de ingesta ni modelos — solo los revisa.
...
- Acceso de lectura a todo el sistema (código, BD, logs).
- Puede bloquear merges y ejecuciones de entrenamiento hasta que se corrijan hallazgos críticos.
