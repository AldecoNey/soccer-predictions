...
- **Nivel C — Medios establecidos:** TyC Sports, Olé, ESPN Argentina — desks editoriales con fuentes propias, sin la trazabilidad directa de A/B. **Amendment (2026-09-21, hallazgo de auditoría QA de la primera corrida real):** esto incluye también diarios/portales regionales o locales con reporterismo propio (ej. La Gaceta de Tucumán, El Día de La Plata, La Unión de Lanús, 0223.com.ar, MDZ Online) — el criterio que importa es "reportea directamente, no republica de otro medio", no el tamaño o alcance nacional/local de la fuente. No se sube a Nivel A/B solo por ser un medio nacional grande, ni se baja a Nivel D solo por ser regional/chico.
